...
The Holle List (hereafter HL) consists of approximately 1000 lexical items designed by [Karel Frederik Holle](https://en.wikipedia.org/wiki/Karel_Holle) (1829-1896), an "eminent authority and lover of the Netherlands Indies and their people" [@holleli1980, 1]. The HL was prepared to be dispersed across the Indonesian archipelago to gather knowledge about the linguistic situation of Indonesia, the then Dutch colony.
...
This Holle List/NBL has been considered to be included in the [Concepticon](https://concepticon.clld.org/) database [@list] (cf. the note [here](https://github.com/concepticon/concepticon-data/issues/1324)).
...
Next, there are two additional tables (to the right panel of @fig-table). These contain phrases and clauses from the 1904/1911 ([raw file](https://github.com/engganolang/digitised-holle-list/blob/main/data/digitised-holle-list-in-stokhof-1980-add-1904_1911.tsv)) and the 1931 ([raw file](https://github.com/engganolang/digitised-holle-list/blob/main/data/digitised-holle-list-in-stokhof-1980-add-1931.tsv)) editions of the HL.

Finally, @fig-transcription provides the transcription table for each edition of the HL, including the approximate phonetic symbols [@holleli1980, 75-77, §6.2].
